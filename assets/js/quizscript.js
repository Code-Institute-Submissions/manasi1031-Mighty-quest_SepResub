...
let questions = [
    {
        ...
        options: ["Sugars", "Carbohydrates", "A Balanced Diet", "Junk Food"]
    },
    {
        numb: 2,
...
function startTimerLine(time){
    ...
    function timer(){
        ...
        if(time > 299){ //if time value is greater than 299
            clearInterval(counterLine); //clear counterLine
        }
    }
}
